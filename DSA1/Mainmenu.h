...
public:
	int draw()
	{
		...
		while (window.isOpen())
		{
			...
			AA.drawText(&window, 50, sf::Color::Blue, sf::Vector2f(164, 55), "Enqueue");
			AA.drawText(&window, 50, sf::Color::Blue, sf::Vector2f(165, 174), "Dequeue");
			AA.drawText(&window, 50, sf::Color::Blue, sf::Vector2f(178, 293), "About");
